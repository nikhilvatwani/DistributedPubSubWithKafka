...
// const consumers = require("./app/utilities/consumers");
var Kafka = require('node-rdkafka')
const broker = require("./app/controllers/broker.controller.js");
const app = express();
var corsOptions = {
      origin: ["http://172.20.0.3:9001","http://172.20.0.8:8080","http://172.20.0.7:8081","http://172.20.0.6:8082","http://172.20.0.5:9000","http://localhost:3000","http://localhost:9001","http://localhost:8080","http://localhost:8081","http://localhost:8082"]
};
const topicConf = {
  /*
    See the reason
